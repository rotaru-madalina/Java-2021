...
public class Program03_Streams {
    public static void main(String[] args) {
        var persoane = List.of(
                ...
                new Persoana("PETRESCU TANASE", 45),
                new Persoana("IFTIMIE BARBU", 26),
                new Persoana("GEORGE THEODOR", 26),
                ...
                new Persoana("DUMITRU ALFONSO", 12),
                new Persoana("ANTON COZMANCA", 50),
                new Persoana("ROBERT GINELA", 34),
                new Persoana("VASILLICA ADAMESCU", 36),
...
//
        ...
        System.out.println("Afisare persoane cu in ordine alfabetica (lexicografica dupa atributul String nume):");
        persoane.stream()
